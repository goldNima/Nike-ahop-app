        ...
        <div>
            <div className='dashboard'>
                <div className='left-dashboard'>
                    ...
                    <br></br>
                    <img alt='img' onClick={Home} className='logo-dashboard-left1' src={home}></img>
                    <br></br>
                    <img alt='img' onClick={cart} className='logo-dashboard-left2' src={store}></img>
                </div>
                <div className='right-dashboard'>
                    <img alt='img' className='img-right-prof' src={profile}></img>
